        ...
        <div class="container">
            ...
            <div class="fotawp-dashboard-content">
                    ...
                    <div id="tabs-content">
                        <div id="fotawp-welcome" class="tab-content">
                            ...
                            <div class="doc-footer">
                                <p><?php echo __('Check out our new font generator and level up your social bios.', 'fotawp') ?></p>
                                <a href="https://cozythemes.com/doc/fotawp/" target="_blank" class="full-doc-btn"><span class="dashicons dashicons-open-folder"></span> <?php echo __('Full Documentation', 'fotawp') ?></a>
                            </div>
                        ...
                        <div id="fotawp-comparision" class="tab-content">
                            ...
                            <h4><?php echo __('How can you access premium features? here is the short guide for using premium features:') ?></h4>
                            ...
                            <table class="dashboard-comparision-table">
                                ...
                                <tr>
                                    ...
                                    <td><span class="dashicons dashicons-no-alt"></span></td>
                                    <td> <span class="dashicons dashicons-saved"></span> 4 Advanced Layout</td>
                                </tr>
                                <tr>
                                    <td><?php echo __('Product List Elementor Widget', 'fotawp') ?></td>
                                    <td> <span class="dashicons dashicons-saved"></span> Basic Layout</td>
                                    <td> <span class="dashicons dashicons-saved"></span> Advanced Layouts</td>
                                </tr>
                                <tr>
                ...
                <div class="fotawp-dashboard-sidebar">
                    ...
                    <div class="sidebar-card">
                        ...
                        <p><?php echo __('We are currently working on the documentation for FOTAWP, and we\'re pleased to announce that it will be released by the end of this week. We appreciate your patience and thank you for your understanding.', 'fotawp') ?></p>
                        <a class="sidebar-btn" href="#" target="_blank"><?php echo __('Doc Link Available soon!', 'fotawp') ?></a>
                    </div>
                    <div class="sidebar-card">
            ...
            <div class="dashboard-footer-cta">
                <div class="notice-content">
                    ...
                    <p> <?php echo __('Access all 25+ demos, 25+ Premium Patterns, 40+ Elementor widgets, Header Footer Builder for Elementor, custom CSS, custom header & footer scripts option and all powerful premium features with just single license!', 'fotawp') ?></p>
