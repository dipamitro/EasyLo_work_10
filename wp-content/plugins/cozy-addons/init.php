...
class Cozy_Addons_Elementor_Widgets
{
    ...
    public static $cozy_addons_pro_widget_stub = [
        "addons" => [
            'cozy_addons_faq' => [
                'title' => 'FAQ',
                'description' => '',
            ...
            'cozy_addons_advanced_magblock' => [
                'title' => 'Magazine Block', 'cozy-addons',
                'description' => '',
                'enable' => false,
            ...
            'cozy_addons_navmenu' => [
                'title' => 'Navigation Menu', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'nav-menu',
            ...
            'cozy_addons_minicart' => [
                'title' => 'Menu Cart', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'minicart',
            ...
            'cozy_addons_sidebar_panel' => [
                'title' => 'Sidebar Panel', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'sidebar-panel',
            ...
            'cozy_addons_menu_search' => [
                'title' => 'Menu Search', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'menu-search',
            ...
            'cozy_addons_toggle_content' => [
                'title' => 'Toggle Content', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'content-toggle',
            ...
            'cozy_addons_footer_copyright_text' => [
                'title' => 'Footer Copyirght Text', 'cozy-addons',
                'description' => '',
                'enable' => false,
            ...
            'cozy_addons_date_time' => [
                'title' => 'Date & Time', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'date-and-time',
            ...
            'cozy_addons_my_account' => [
                'title' => 'My Account', 'cozy-addons',
                'description' => '',
                'enable' => false,
                'slug' => 'my-account',
    ...
    public function cozy_addons_widget_styles()
    {
        ...
        wp_enqueue_style('widgets-style', plugins_url('public/css/widgets-style.css', __FILE__));
        wp_enqueue_style('swiper-bundle', plugins_url('public/css/swiper-bundle.css', __FILE__));
        wp_enqueue_script('swiper-bundle', COZY_ADDONS_PLUGIN_URL . '/public/js/swiper-bundle.js', array('jquery'), '7.4.1', true);
        wp_enqueue_script('typeout-core', COZY_ADDONS_PLUGIN_URL . '/public/js/core.js', array('jquery'), '', true);
        wp_enqueue_script('easy-news-ticker', COZY_ADDONS_PLUGIN_URL . '/public/js/jquery.easy-ticker.min.js', array('jquery'), '', true);
        wp_enqueue_script('cozy-scripts', COZY_ADDONS_PLUGIN_URL . '/public/js/cozy-scripts.js', array('jquery'), '', true);
        wp_localize_script('cozy-scripts', 'ajax_object', array(
    ...
    {
        wp_enqueue_style('cozy-dashboard-style', COZY_ADDONS_PLUGIN_URL . '/admin/css/cozy-dashboard-style.css', '', 'all');
    }
    ...
    {
        wp_enqueue_script('cozy-addons-scripts', COZY_ADDONS_PLUGIN_URL . '/admin/js/cozy-addons-scripts.js', array('jquery'), '', true);
    }
    ...
    public function get_stub_widgets($settings)
    {
        ...
        $cozy_addons_stub_widgets = Cozy_Addons_Elementor_Widgets::$cozy_addons_pro_widget_stub['addons'];
    ...
    public function __construct()
    {
        ...
        add_action('elementor/frontend/after_enqueue_styles', [$this, 'cozy_addons_widget_styles']);
        add_action('elementor/editor/after_enqueue_styles', [$this, 'cozy_addons_admin_enqueue_styles']);
        add_action('elementor/editor/before_enqueue_scripts', [$this, 'cozy_adoons_admin_scripts']);
        add_action('elementor/preview/enqueue_styles', [$this, 'cozy_adoons_admin_scripts']);
        //add_action('elementor/editor/after_enqueue_scripts', [$this, 'cozy_admin_enqueue_custom_scripts']);

        // Register widgets
        add_action('elementor/widgets/register', [$this, 'cozy_addons_widgets_registered']);
