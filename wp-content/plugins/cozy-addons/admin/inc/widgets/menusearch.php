...
class Cozy_Addons_MenuSearch_Widget extends Widget_Base
{
    ...
    private function cozy_addons_menusearch_options()
    {
        ...
        $this->add_control(
            'searchbox_width',
            [
                'label' => __('Searchbox Width', 'cozy-addons'),
    ...
    private function cozy_addons_menu_searchbox_icon_styles()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cozy-addons-menu-search i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cozy-addons-menu-search i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cozy-addons-menu-search i' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'rgba(0,0,0,0)',
                'selectors' => [
                    '{{WRAPPER}} .cozy-addons-menu-search i' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => '#B6B6B6',
                'selectors' => [
                    '{{WRAPPER}} .cozy-addons-menu-search i' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'rgba(0,0,0,0)',
                'selectors' => [
                    '{{WRAPPER}} .cozy-addons-menu-search i:hover' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => '#676767',
                'selectors' => [
                    '{{WRAPPER}} .cozy-addons-menu-search i:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    private function cozy_addons_menu_searchbox_styles()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cozy-addons-menu-search .cozy-searchbox.display-default' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
                'condition' => [
                    'menu_search_display_option' => 'display-default',
                ],
