	...
	private function cozy_addons_cart_button_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-products-slider .product-box a.button.before-text .svg-inline--fa' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} section.cozy-addons-products-slider .product-box a.button.after-text .svg-inline--fa' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
