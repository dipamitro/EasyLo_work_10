...
namespace Cozy_Addons\AdvancedMagBlockWidgets;
 ...
 * @since 1.1.0
 */
class Cozy_Addons_Advanced_MagBlock_Widget extends Widget_Base
{

	public function get_name()
	{
		return 'cozy-addons-advanced-magblock';
	}

	public function get_title()
	{
		return __('Magazine Block', 'cozy-addons');
	}

	public function get_icon()
	{
		return 'eicon-posts-carousel cozy-widget-icons';
	}
	public function get_keywords()
	{
		return ['advanced magazine block', 'news block', 'blogs and posts', 'cozy addons'];
	}
	...
	private function cozy_addons_query_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => 'mag-block-1',
				'options' => [
					'mag-block-1' => esc_html__('Grid', 'cozy-addons'),
					'mag-block-3' => esc_html__('Carousel', 'cozy-addons'),
					'mag-block-4' => esc_html__('List', 'cozy-addons'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'col-list-3' => esc_html__('3 Column', 'cozy-addons'),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'relation' => 'or',
					'terms' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'relation' => 'or',
					'terms' => [
	...
	private function cozy_addons_blog_style_heading_options()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header h3',
				'fields_options' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header .section-heading span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header .section-heading span' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '#000000',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header h3' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header .section-heading',
			]
		);
	...
	private function cozy_addons_cta_button_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more .button-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more.before-text .button-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder a.ca-post-more.after-text .button-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more',
				'fields_options' => [
					'typography' => ['default' => 'yes'],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-ca-post-more',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		// Box color
		$this->add_control(
			...
			[
				...
				'default'   => '#6EC1E4',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more' => 'background: {{VALUE}};',
				],
			]
		);
		//button text color
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more:hover',
			]
		);
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		// Box color
		$this->add_control(
			...
			[
				...
				'default'   => '#61CE70',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more:hover' => 'background: {{VALUE}};',
				],
			]
		);
		//button text color
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.cta a.ca-post-more:hover' => 'color: {{VALUE}};',
				],
			]
		);
	...
	private function cozy_addons_content_image_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-featured-post .cozy-featured-img' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}}  section.cozy-addons-advanced-magazine-block.mag-block-4 .mag-block-holder .mag-featured-post .mag-list-item .cozy-featured-img' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'mag_block_layout' => 'mag-block-4',
				],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}}  section.cozy-addons-advanced-magazine-block .mag-featured-post .cozy-featured-img img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  section.cozy-addons-advanced-magazine-block .mag-featured-post .cozy-featured-img img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-featured-post .cozy-featured-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-featured-post .cozy-featured-img img',
			]
		);
		$this->end_controls_section();
	}
	...
	private function cozy_addons_cta_style_box_options()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-list-item' => 'text-align: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item',
				'fields_options' => [
					'typography' => ['default' => 'yes'],
					'font_size' => ['default' => ['size' => 16]],
					'font_weight' => ['default' => 400],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-list-item .mag-list-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => ['gradient'],
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder.content-overlay-enabled .mag-list-item:before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __('Background Color', 'cozy-addons'),
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '#777777',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item' => 'color: {{VALUE}};',
				],
			]
		);
		// Normal border
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __('Background Color', 'cozy-addons'),
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item:hover' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			'box_color_color_hover',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __('Color', 'cozy-addons'),
				'default'   => '#777777',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item:hover' => 'color: {{VALUE}};',
				],
			]
		);
		// Hover border shadow
		$this->add_group_control(
			...
			[
				'name' => 'border_hover',
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item:hover',
			]
		);
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-featured-post .mag-list-item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	private function cozy_addons_blog_style_title_options()
	{
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder a .post-title',
				'fields_options' => [
					'typography' => ['default' => 'yes'],
					'font_size' => ['default' => ['size' => 20]],
					'font_weight' => ['default' => 600],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder a .post-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#000000',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder a .post-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#777777',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder a:hover .post-title' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
	...
	private function cozy_addons_blog_style_meta_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta.all' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta span.meta-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta span.meta-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta .meta-label' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta span.cozy-post-meta' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta',
				'fields_options' => [
					'typography' => ['default' => 'yes'],
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#787878',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#787878',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ededed',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .cozy-post-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
	...
	private function cozy_addons_blog_carousel_navigation_options()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav.cozy-slide-next' => 'line-height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav.cozy-slide-prev' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav',
			]
		);
		// Normal border shadow
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		// Box color
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'background: {{VALUE}};',
				],
			]
		);
		//button text color
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav:hover',
			]
		);
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		// Box color
		$this->add_control(
			...
			[
				...
				'default'   => '#000000',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav:hover' => 'background: {{VALUE}};',
				],
			]
		);
		//button text color
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder .mag-section-header span.slider-navigation .cozy-slide-nav:hover' => 'color: {{VALUE}};',
				],
			]
		);
	...
	private function cozy_addons_blog_meta_category_options()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category',
				'fields_options' => [
					'typography' => ['default' => 'yes'],
					'font_size' => ['default' => ['size' => 13]],
					'font_weight' => ['default' => 400],
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ededed',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '#787878',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a',
			]
		);
		// Hover border radius
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#232323',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a:hover' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '#ededed',
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => __('Border', 'cozy-addons'),
				'selector' => '{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a:hover',
			]
		);
		// Hover border radius
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} section.cozy-addons-advanced-magazine-block .mag-block-holder span.category a:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render($instance = [])
	{
		if (cozy_addons_premium_access()) {
			...
			<section class="cozy-addons-advanced-magazine-block <?php echo esc_attr($slected_layout); ?>">
				<?php
				include(COZY_ADDONS_PLUGIN_DIR . 'public/widgets/posts/advanced-magblock-layout.php');
				?>
