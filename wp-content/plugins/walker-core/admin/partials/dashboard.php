		...
		<div class="dashboard-box">
			...
			?>
				...
				<div class="walker-dashboard-col-half right-part">
					...
					echo __("Please use any of our following themes to use Walker Core", 'walker-core');
					?>
					<ul>
						<li><strong><?php echo __('BlockVerse - Modern and FSE WordPress Theme (upcoming)', 'walker-core'); ?></strong></li>
						...
						<li><?php echo __('WalkerPress - recommended for magazine/news based traditional theme', 'walker-core'); ?></li>
